...
- **ONNX Runtime Web**: in-browser NN inference for sole mesh deformation. NN trained using an NNFE approach similar to that described by Sacks et al. in papers including [this](https://www.sciencedirect.com/science/article/abs/pii/S0045782524003165) and code [here](https://github.com/BenThomas324/NNFE).
- **Vite** static web app
